 ...
 * FIXED: Proper enum usage, removed conflicts
 */
public class Contractor extends Employee {
    ...
    public Contractor() {
        ...
        // FIXED: Use proper enum from Employee class
        setStatus(Employee.EmploymentStatus.CONTRACTUAL);
    }
    ...
    public long getDaysUntilContractEnd() {
        ...
        return java.time.temporal.ChronoUnit.DAYS.between(LocalDate.now(), contractEndDate);
    }
