 ...
 * FIXED: Removed enum conflicts, uses proper Employee.EmploymentStatus
 */
public class Manager extends Employee {
    ...
    public Manager(String firstName, String lastName, int employeeId, double managementAllowance) {
        ...
        // Managers are typically regular employees - FIXED to use proper enum
        setStatus(Employee.EmploymentStatus.REGULAR);
    }
